...
// Define the full dataset of 25 core open-source LLMs studied from llm-explorer.com
const MODELS_DATA = [
  {
    id: 'deepseek-r1',
    name: 'DeepSeek-R1',
    ...
    benchmarks: { mmlu: 90.8, humanEval: 92.6, gsm8k: 96.3 },
    deployment: {
  ...
  },
  {
    ...
    benchmarks: { mmlu: 88.5, humanEval: 82.6, gsm8k: 90.2 },
    deployment: {
  ...
  },
  {
    ...
    commercialAllowed: true,
    primaryUseCases: ['General Assistant', 'Coding', 'Reasoning & Math'],
    benchmarks: { mmlu: 88.6, humanEval: 84.8, gsm8k: 93.4 },
    deployment: {
  ...
  },
  {
    ...
    benchmarks: { mmlu: 90.1, humanEval: 89.0, gsm8k: 95.2 },
    deployment: {
  ...
  },
  {
    ...
    commercialAllowed: true,
    primaryUseCases: ['General Assistant', 'Coding', 'Reasoning & Math'],
    benchmarks: { mmlu: 86.0, humanEval: 80.5, gsm8k: 91.2 },
    deployment: {
  ...
  },
  {
    ...
    benchmarks: { mmlu: 68.4, humanEval: 72.6, gsm8k: 82.3 },
    deployment: {
  ...
  },
  {
    ...
    commercialAllowed: true,
    primaryUseCases: ['General Assistant', 'Coding', 'Reasoning & Math'],
    benchmarks: { mmlu: 85.3, humanEval: 83.5, gsm8k: 91.8 },
    deployment: {
  ...
  },
  {
    ...
    license: 'Apache-2.0',
    commercialAllowed: true,
    primaryUseCases: ['Coding', 'General Assistant'],
    benchmarks: { mmlu: 83.1, humanEval: 91.5, gsm8k: 88.9 },
    deployment: {
  ...
  },
  {
    ...
    benchmarks: { mmlu: 79.8, humanEval: 78.4, gsm8k: 85.3 },
    deployment: {
  ...
  },
  {
    ...
    license: 'Apache-2.0',
    commercialAllowed: true,
    primaryUseCases: ['Coding', 'Local / On-device', 'Low-Latency'],
    benchmarks: { mmlu: 71.5, humanEval: 85.4, gsm8k: 78.2 },
    deployment: {
  ...
  },
  {
    ...
    commercialAllowed: true,
    primaryUseCases: ['Local / On-device', 'Low-Latency', 'General Assistant'],
    benchmarks: { mmlu: 74.2, humanEval: 71.8, gsm8k: 81.2 },
    deployment: {
      ollamaId: 'qwen2.5:7b',
  ...
  },
  {
    ...
    commercialAllowed: true,
    primaryUseCases: ['General Assistant', 'Reasoning & Math', 'Coding'],
    benchmarks: { mmlu: 81.3, humanEval: 72.0, gsm8k: 89.0 },
    deployment: {
      ollamaId: 'gemma2:27b',
  ...
  },
  {
    ...
    commercialAllowed: true,
    primaryUseCases: ['Local / On-device', 'Low-Latency', 'General Assistant'],
    benchmarks: { mmlu: 75.3, humanEval: 62.2, gsm8k: 84.1 },
    deployment: {
      ollamaId: 'gemma2:9b',
  ...
  },
  {
    ...
    benchmarks: { mmlu: 63.8, humanEval: 42.1, gsm8k: 67.2 },
    deployment: {
      ollamaId: 'gemma2:2b',
  ...
  },
  {
    ...
    license: 'MIT',
    commercialAllowed: true,
    primaryUseCases: ['Reasoning & Math', 'Coding', 'Local / On-device'],
    benchmarks: { mmlu: 82.5, humanEval: 86.6, gsm8k: 92.2 },
    deployment: {
      ollamaId: 'phi4',
  ...
  },
  {
    ...
    commercialAllowed: true,
    primaryUseCases: ['Local / On-device', 'Low-Latency', 'General Assistant'],
    benchmarks: { mmlu: 78.9, humanEval: 71.8, gsm8k: 83.5 },
    deployment: {
      ollamaId: 'phi3.5-moe',
  ...
  },
  {
    ...
    primaryUseCases: ['General Assistant', 'Coding', 'Reasoning & Math'],
    benchmarks: { mmlu: 84.0, humanEval: 76.2, gsm8k: 87.5 },
    deployment: {
  ...
  },
  {
    ...
    benchmarks: { mmlu: 76.8, humanEval: 62.5, gsm8k: 80.1 },
    deployment: {
  ...
  },
  {
    ...
    commercialAllowed: true,
    primaryUseCases: ['Reasoning & Math', 'Coding', 'General Assistant'],
    benchmarks: { mmlu: 77.8, humanEval: 71.1, gsm8k: 82.4 },
    deployment: {
  ...
  },
  {
    ...
    commercialAllowed: true,
    primaryUseCases: ['Local / On-device', 'Low-Latency', 'General Assistant'],
    benchmarks: { mmlu: 70.6, humanEval: 50.4, gsm8k: 68.2 },
    deployment: {
  ...
  },
  {
    ...
    benchmarks: { mmlu: 75.6, humanEval: 61.0, gsm8k: 76.1 },
    deployment: {
  ...
  },
  {
    ...
    benchmarks: { mmlu: 72.4, humanEval: 71.3, gsm8k: 79.6 },
    deployment: {
      ollamaId: 'glm4:9b',
  ...
  },
  {
    ...
    commercialAllowed: true,
    primaryUseCases: ['General Assistant', 'Coding', 'Reasoning & Math'],
    benchmarks: { mmlu: 90.1, humanEval: 88.5, gsm8k: 94.2 },
    deployment: {
  ...
  },
  {
    ...
    commercialAllowed: true,
    primaryUseCases: ['Local / On-device', 'Low-Latency'],
    benchmarks: { mmlu: 64.3, humanEval: 45.4, gsm8k: 72.8 },
    deployment: {
  ...
  },
  {
    ...
    commercialAllowed: true,
    primaryUseCases: ['Local / On-device', 'Low-Latency'],
    benchmarks: { mmlu: 49.3, humanEval: 31.2, gsm8k: 52.4 },
    deployment: {
...
async function syncAndBuild() {
  console.log('=== RETRIEVING LIVE METADATA FROM HUGGING FACE API ===');
  const enrichedModels = [];

  for (const model of MODELS_DATA) {
    const enriched = { ...model };
    try {
      console.log(`Fetching live HF stats for: ${model.name} (${model.deployment.hfRepo})...`);
      const res = await fetch(`https://huggingface.co/api/models/${model.deployment.hfRepo}`, {
        headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36' }
      });
      if (res.ok) {
        const info = await res.json();
        if (info.downloads !== undefined) {
          enriched.downloads = info.downloads;
        }
        if (info.likes !== undefined) {
          enriched.likes = info.likes;
        }
        if (info.lastModified !== undefined) {
          enriched.lastUpdated = info.lastModified.substring(0, 10);
        }
        console.log(`  -> Downloads: ${info.downloads || 'N/A'}, Likes: ${info.likes || 'N/A'}`);
      } else {
        console.warn(`  -> Could not query HF API (Status ${res.status}). Using placeholder stats.`);
      }
    } catch (err) {
      console.error(`  -> Failed to reach HF for ${model.name}: ${err.message}`);
    }
    enrichedModels.push(enriched);
  }

  console.log('\n=== COMPLETE STUDY COMPLETED: 25 MODELS CONSTRUCTED ===');

  // Update src/data/models.ts
  const modelsTsPath = path.join(process.cwd(), 'src/data/models.ts');
  const tsContent = `export interface ModelMetadata {
  id: string;
  name: string;
  provider: 'Meta' | 'Google' | 'Microsoft' | 'DeepSeek' | 'Mistral AI' | 'Alibaba Qwen' | 'Cohere' | 'Zhipu AI';
  releaseDate: string;
  description: string;
  parameters: string;
...
export const OPEN_SOURCE_MODELS: ModelMetadata[] = ${JSON.stringify(enrichedModels, null, 2)};
...
`;
  ...
  fs.writeFileSync(modelsTsPath, tsContent, 'utf-8');
  console.log(`Saved enriched dataset directly to ${modelsTsPath}`);

  // Update README.md between <!-- REGISTRY_JSON_START --> and <!-- REGISTRY_JSON_END -->
  ...
  if (fs.existsSync(readmePath)) {
    ...
    if (startIndex !== -1 && endIndex !== -1) {
      const before = readmeText.substring(0, startIndex + startMarker.length);
      const after = readmeText.substring(endIndex);
      const jsonContentBlock = `\n\`\`\`json\n${JSON.stringify(enrichedModels, null, 2)}\n\`\`\`\n`;
      const updatedReadme = before + jsonContentBlock + after;
      fs.writeFileSync(readmePath, updatedReadme, 'utf-8');
      console.log(`Successfully updated ${readmePath} between database markers!`);
    } else {
      console.error('Error: Could not find REGISTRY markers in README.md!');
    }
  } else {
    console.warn('Warning: README.md not found in process root!');
  }

  console.log('=== SYNC PIPELINE RUN COMPLETED SUCCESSFULLY ===');
}
